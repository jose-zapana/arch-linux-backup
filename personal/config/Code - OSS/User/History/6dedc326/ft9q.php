...
<form action="{{ route('admin.posts.categories.update', $blogcategory) }}" method="POST">
    ...
    <div class="card dark:bg-gray-800 dark:text-white">
        ...
        <div class="mb-4">
            ...
            <x-input class="w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" placeholder="Ingrese el nombre de la categoría" name="name" value="{{ old('name', $blogcategory->name) }}" />
        </div>
