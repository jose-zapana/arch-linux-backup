...
class Product extends Model implements HasMedia
{
    ...
    public function registerMediaConversions(?Media $media = null): void
    {
        $this->addMediaConversion('thumb')
            ->width(368)               // Establece el ancho máximo de la imagen a 368px
            ->height(232)              // Establece la altura máxima de la imagen a 232px
            ->format('webp')           // Convierte la imagen a formato WebP
            ->nonQueued();             // No usa colas, se procesa de inmediato
    }
}
