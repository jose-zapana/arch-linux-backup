            ...
            @if ($newAddress)
                ...
                <div x-data="{
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
                        ...
                        <div>
                            <button wire:click="store" class="btn bg-indigo-500 text-white w-full mt-4 py-2 text-center text-base md:text-lg hover:bg-indigo-600 transition disabled:bg-gray-300 disabled:text-gray-500">
                                Guardar
                            </button>
            ...
            @else
                ...
                <div x-data="{
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
                        ...
                        <div>
                            <button wire:click="update()" class="btn bg-indigo-600 text-white hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-600 rounded-lg shadow-lg w-full transition-all">
                                Actualizar
                            </button>
                    ...
                    @if ($addresses->count())
                        <ul class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                            @foreach ($addresses as $address)
                                <li class="{{ $address->default ? 'bg-indigo-300' : 'bg-white' }} rounded-lg shadow"
                                    ...
                                    <div class="p-4 flex items-center">
                                        ...
                                        <div class="text-xs text-indigo-600 flex flex-col">
