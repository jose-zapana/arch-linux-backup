            ...
            @if ($newAddress)
                ...
                <div x-data="{
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
                        ...
                        <div>
                            <button wire:click="store" class="btn bg-indigo-500 text-white w-full  text-center text-base md:text-lg hover:bg-indigo-600 transition disabled:bg-gray-300 disabled:text-gray-500">
                                Guardar
                            </button>
