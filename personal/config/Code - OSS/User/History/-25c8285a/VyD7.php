            ...
            @else
                ...
                <ul class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                    @foreach ($addresses as $address)
                        <li class="{{ $address->default ? 'bg-indigo-500 text-white' : 'bg-white text-gray-700' }} rounded-lg shadow"
                            ...
                            <div class="p-4 flex items-center">
                                ...
                                <div class="text-xs flex flex-col space-y-2">
                                    <button wire:click="setDefaultAddress({{ $address->id }})" class="hover:text-indigo-600">
                                        <i class="fa-solid fa-star"></i>
                                    </button>
                                    <button wire:click="edit({{ $address->id }})" class="hover:text-indigo-600">
                                        <i class="fa-solid fa-pencil"></i>
                                    </button>
                                    <button wire:click="deleteAddress({{ $address->id }})" class="hover:text-red-500">
