...
class PostController extends Controller
{
    ...
    {   
        ...
        SEOMeta::setDescription($post->extract); // Descripción del post (extracto)
        SEOMeta::setCanonical(route('posts.show', $post)); // URL canónica del post
        SEOMeta::addKeyword([$post->name, 'soporte técnico', 'mantenimiento de laptops', 'venta de ordenadores', 'accesorios de computadoras', 'repuestos', 'La Molina', 'Cieneguilla', 'Manchay']);
        ...
        OpenGraph::setDescription($post->extract); // Descripción para OpenGraph
        ...
        JsonLd::setDescription($post->extract); // Descripción en JSON-LD
