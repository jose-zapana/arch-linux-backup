    ...
    <div class="py-12">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
          ...
          <img fetchpriority="high" class="w-full h-80 object-cover object-center mb-6" 
          ...
          <ul>
            ...
            <li class="mb-4">
              <a class="flex" href="{{ route('posts.show', $similar) }}">
                @if ($similar->getFirstMedia('posts'))
                <img fetchpriority="high" class="w-16 h-16 object-cover object-center" 
                  src="{{ $similar->getFirstMediaUrl('posts', 'thumb') }}" 
                  alt="{{ $similar->name }}">
                @else
                <img 
