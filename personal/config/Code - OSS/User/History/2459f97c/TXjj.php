    ...
    <div class="py-12">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
          ...
          @if ($post->hasMedia('images')) <!-- Verificar si tiene imagen en la colección -->
            <img 
            ...
            @foreach ($similares as $similar)
              <li class="mb-4">
                <a class="flex items-center hover:bg-gray-200 dark:hover:bg-gray-700 p-2 rounded-lg transition" 
                  ...
                  @if ($similar->hasMedia('images')) <!-- Verificar si tiene imagen en la colección -->
                    <img 
                      class="w-16 h-16 object-cover object-center rounded-lg" 
                      src="{{ $similar->getFirstMediaUrl('images') }}" 
