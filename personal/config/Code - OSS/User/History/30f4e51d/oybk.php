...
class Post extends Model implements HasMedia
{
    ...
    public function registerMediaConversions(?Media $media = null): void
    {
        ...
        // Conversión para imágenes grandes
        $this->addMediaConversion('large')
            ->width(640)                   // Define el ancho deseado
            ->height(480)                  // Define el alto deseado
            ->format('webp')               // Convierte al formato WebP
            ->quality(80)                  // Comprime con un 80% de calidad
            ->nonQueued();                 // Procesa de forma inmediata
    }
