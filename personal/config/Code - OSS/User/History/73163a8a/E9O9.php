<div class="bg-white dark:bg-gray-900 text-black dark:text-white">
    <form wire:submit="store">
        ...
        <div class="card bg-white dark:bg-gray-800">
            ...
            <div class="mb-4" x-data x-init="ClassicEditor.create($refs.editor).then(editor => {
            ...
            <textarea x-ref="editor" class="w-full bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300"
