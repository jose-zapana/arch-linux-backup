    ...
    <form wire:submit="store">
        <figure class="mb-4 relative">
            <div class="absolute top-8 right-8">
                <label class="flex items-center px-4 py-2 rounded-lg bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 cursor-pointer text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                    ...
                    Actualizar imagen
                    <input type="file" id="file" name="file" class="hidden" accept="image/*" onchange="previewImage(event)"> <!-- Añadido evento onchange -->
                </label>
            </div>
        ...
        <div class="card bg-white dark:bg-gray-800">
            ...
            <div class="mb-4">
                ...
                <x-textarea wire:model="product.description" name="description" id="description" class="w-full bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300"
