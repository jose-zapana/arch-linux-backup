<div class="bg-white dark:bg-gray-900 text-black dark:text-white">
    <form wire:submit="store">
        <figure class="mb-4 relative">
            ...
            <img class="aspect-[16/9] object-cover object-center w-1/2 mx-auto" src="{{ $image ? $image->temporaryUrl() : asset('img/icons/no-image.png') }}" alt="">
        ...
        <div class="card bg-white dark:bg-gray-800">
            ...
            <div class="mb-4">
                ...
                <x-textarea wire:model="product.description" class="w-full bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300"
