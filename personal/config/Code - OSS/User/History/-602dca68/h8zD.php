...
<div class="card dark:bg-gray-800 dark:text-white">
  <form action="{{ route('admin.posts.categories.store') }}" method="POST">
      ...
      <div class="mb-4">
          ...
          <x-input class="w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" placeholder="Ingrese el slug de la categoría" name="slug" id="slug" value="{{ old('slug') }}" />
      </div>
