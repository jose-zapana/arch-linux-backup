        ...
        <div class="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
            <div class="space-y-3">
                ...
                <ul class="space-y-1">
                    ...
                    <li>
                        <a href="https://api.whatsapp.com/send/?phone=51957686487&text=Hola%21+Escribo+desde+la+web+de+pc-hard.com&type=phone_number&app_absent=0" data-turbo="false">Contáctanos</a>
                    </li>
                </ul>
            </div>
