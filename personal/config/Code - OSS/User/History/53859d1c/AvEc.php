<div>
    <section class="rounded-lg border border-gray-100 bg-white shadow-lg dark:border-gray-700 dark:bg-gray-800">

        <header class="border-b border-gray-200 px-6 py-2 dark:border-gray-600">
                ...
                <div class="space-y-6">
                    ...
                    @foreach ($product->options as $option)
                        <div wire:key="product-option-{{ $option->id }}"
                            class="p-6 rounded-lg border border-gray-200 relative dark:border-gray-600 dark:bg-gray-700">

                            <div class="absolute -top-3 px-4 bg-white dark:bg-gray-800">
                            ...
                            <div class="flex">
                                ...
                                <div class="flex-1">
                                    ...
                                    wire:model="newFeature.{{ $option->id }}"
                                    >
                                ...
                                <div>
                                    <x-button wire:click="addFeature({{ $option->id }})">
                                        Agregar
                                    </x-button>
                                </div>
        ...
        <section class="rounded-lg border border-gray-100 bg-white shadow-lg mb-12 dark:border-gray-700 dark:bg-gray-800">
            ...
            <div class="p-6">
                <ul class="divide-y -my-4 dark:divide-gray-600">

                    @foreach ($product->variants as $item)
                        <li class="py-4 flex items-center dark:text-gray-300">
                            <img src="{{ $item->image }}" class="w-12 h-12 object-cover object-center">

                            <p class="divide-x dark:divide-gray-600">
            ...
            <ul class="mb-4 space-y-4">
                ...
                @foreach ($variant['features'] as $index => $feature)
                    <li wire:key="variant-feature-{{ $index }}"
                        class="relative border border-gray-200 rounded-lg p-6 dark:border-gray-600 dark:bg-gray-800">

                        <div class="absolute -top-3 bg-white px-4 dark:bg-gray-800">

                            <button>
                                <i class="fa-solid fa-trash text-red-500 hover:text-red-600"
    ...
    <x-dialog-modal wire:model="variantEdit.open">
        ...
        <x-slot name="title">
            ...
            <div class="mb-4">
                ...
                <x-input class="w-full" wire:model="variantEdit.sku" label="SKU" />
            </div>
            ...
            <div>
                ...
                <x-input class="w-full" wire:model="variantEdit.stock" label="Stock" />
            </div>
