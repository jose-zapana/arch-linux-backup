...
class ShippingAddresses extends Component
{
    ...
    {
        // Obtén las direcciones actualizadas para el usuario autenticado
        $this->addresses = Address::where('user_id', auth()->id())->get();
        
        // Emite el evento 'updateAddresses' al componente 'summary' pasando las direcciones actualizadas
        $this->emitTo('summary', 'updateAddresses', $this->addresses);
    }
