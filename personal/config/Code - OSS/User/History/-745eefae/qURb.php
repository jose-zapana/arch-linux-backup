...
class ShippingAddresses extends Component
{
    ...
    public $addresses;
    public $hasAddresses = false; // Propiedad para verificar si hay direcciones
    ...
    public function mount()
    {
        ...
        // Emitir un evento para indicar si hay direcciones
        if ($this->addresses->isNotEmpty()) {
            $this->emit('hasAddresses', true);
        } else {
            $this->emit('hasAddresses', false);
        }
