...
class ShippingAddresses extends Component
{
    ...
    {
        $this->addresses = Address::where('user_id', auth()->id())->get() ?? collect();
        
        // Emitir el evento a otro componente para actualizar las direcciones
        $this->emitTo('shipping-addresses', 'updateAddresses', $this->addresses->toArray());
    }
    ...
    public function store()
    {
        ...
        // Emitir el evento para actualizar las direcciones
        $this->emitTo('shipping-addresses', 'updateAddresses', $this->addresses->toArray());
    }
    ...
    public function update()
    {
        ...
        // Emitir evento con las direcciones actualizadas
        $this->emitTo('summary', 'updateAddresses', $this->addresses);  // Emite el evento con el array de direcciones
    }
