        ...
        if (document.querySelector('#body')) {
            ClassicEditor
                .create(document.querySelector('#body'), {
                    ...
                    image: {
                        toolbar: [
                            'imageStyle:alignLeft',    // Alinear a la izquierda
                            'imageStyle:full',        // Imagen completa
                            'imageStyle:alignCenter', // Centrada
                            'imageStyle:alignRight',  // Alinear a la derecha
                            '|',
                            'resizeImage',            // Habilitar redimensionamiento
                            'imageTextAlternative'    // Texto alternativo
                        ],
                        styles: [
                            'full',        // Imagen ocupa todo el ancho
                            'alignLeft',   // Imagen alineada a la izquierda
                            'alignCenter', // Imagen centrada
                            'alignRight'   // Imagen alineada a la derecha
                        ]
                    },
                    heading: {
                        options: [
