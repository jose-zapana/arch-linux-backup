...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const isDarkMode = document.body.classList.contains('dark'); // Ajusta según la clase de tu tema
        ...
        if (document.querySelector('#body')) {
            ClassicEditor
                .create(document.querySelector('#body'), {
                    ...
                    // Asigna el tema dinámicamente
                    contentsCss: isDarkMode ? 'path/to/dark-theme.css' : 'path/to/light-theme.css',
                })
                .catch(error => {
                    console.error(error);
                });
