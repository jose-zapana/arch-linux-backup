...
document.addEventListener("DOMContentLoaded", function () {
        ...
        ClassicEditor
            .create(document.querySelector('#body'), {
                toolbar: [
                    'imageUpload', 
                    '|', 
                    'imageTextAlternative', // Opción para gestionar el atributo "alt"
                    'imageStyle:full', 
                    'imageStyle:side', 
                    '|', 
                    'bold', 
                ...
                image: {
                    toolbar: [
                        'imageTextAlternative', // Opción para editar el atributo "alt"
                        'imageStyle:alignLeft', 
                        'imageStyle:alignCenter', 
                        'imageStyle:alignRight', 
                        '|', 
                        'resizeImage' // Opción para cambiar el tamaño
                    ],
                    resizeOptions: [
                        {
    ...
    // Repite esta configuración para el campo #extract si es necesario.
});
