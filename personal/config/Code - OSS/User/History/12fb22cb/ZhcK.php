...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        const isDarkMode = document.documentElement.classList.contains('dark'); // Detectar si el modo oscuro está activo
        ...
        const editorConfig = {
            ...
            contentsCss: `
                .ck-content {
                    ...
                    background-color: ${isDarkMode ? '#1F2937' : '#FFFFFF'}; /* Fondo según modo */
                    color: ${isDarkMode ? '#E5E7EB' : '#1F2937'}; /* Texto según modo */
                }
                .ck-content h1, .ck-content h2, .ck-content h3, .ck-content h4, .ck-content h5 {
                    color: ${isDarkMode ? '#F3F4F6' : '#1F2937'}; /* Encabezados */
                }
            `
        };
        ...
        if (document.querySelector('#extract')) {
            ClassicEditor
                .create(document.querySelector('#extract'), editorConfig)
                .catch(error => {
                    console.error(error);
                });
        }
