...
<form action="{{ route('admin.blogs.update', $blog) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="card bg-white dark:bg-gray-800">
        ...
        <figure class="mb-4 relative">
            ...
            <!-- Mostrar la imagen actual de la MediaLibrary -->
            <img id="picture" 
                 class="aspect-[16/9] object-cover object-center w-1/2 mx-auto rounded-lg shadow-md dark:shadow-lg" 
                 src="{{ $blog->getFirstMediaUrl('images', 'thumb') ?: asset('img/no-image.png') }}" 
                 alt="Imagen actual">
        </figure>
...
De forma predeterminada, algunos de estos formatos no están incluidos en el preajuste estándar debido a la CKEDITOR.config.formato_tags configuración disponible en el config.js archivo, pero puede habilitarlos fácilmente utilizando una de las siguientes soluciones. El mismo procedimiento también se aplica a limitar el número de opciones de formato de texto disponibles en el editor.

Habilitación de Todos los Formatos de Texto de Nivel de Bloque