        ...
        <div class="card bg-white dark:bg-gray-800">
            ...
            <div class="mb-4">
                ...
                <div class="flex flex-wrap space-x-4 text-gray-700 dark:text-gray-200">
                    @foreach ($tags as $tag)
                        <div>
                            <input type="checkbox" id="tag{{ $tag->id }}" name="tags[]" value="{{ $tag->id }}" @checked(in_array($tag->id, old('tags', []))) class="dark:bg-gray-700 dark:border-gray-600">
            ...
            <div class="mb-4">
                ...
                <div class="flex items-center space-x-2 text-gray-700 dark:text-gray-300">
                    <div class="flex items-center space-x-2">
                        <input type="radio" name="status" id="status1" value="1" @checked(old('status') == 1) aria-labelledby="status1" class="dark:bg-gray-700 dark:border-gray-600">
                        <label for="status1" class="dark:text-gray-300">Borrador</label>
                    </div>
                    <div class="flex items-center space-x-2">
                        <input type="radio" name="status" id="status2" value="2" @checked(old('status') == 2) aria-labelledby="status2" class="dark:bg-gray-700 dark:border-gray-600">
            ...
            <div class="flex justify-end space-x-2">
                <x-button class="dark:bg-blue-700">Crear</x-button>
            </div>
        </div>
    </form>
