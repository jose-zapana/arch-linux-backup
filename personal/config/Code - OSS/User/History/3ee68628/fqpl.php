<div class="card dark:bg-gray-800 dark:text-white">
  <form action="{{ route('admin.blogs.store') }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="mb-4">
          ...
          <x-input id="name" name="title" class="w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" placeholder="Escribe un título" value="{{ old('title') }}" autocomplete="off" />
      </div>
      <div class="mb-4">
