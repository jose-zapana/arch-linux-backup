    ...
    <form wire:submit="store">
        ...
        <div class="card dark:bg-gray-800">
            ...
            <div class="mb-4">
                ...
                <x-textarea wire:model="postEdit.description" class="w-full dark:bg-gray-700 dark:text-gray-300"
                    placeholder="Por favor ingrese la descripción del posto">
                </x-textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <x-input type="number" step="0.01" wire:model="postEdit.price" class="w-full dark:bg-gray-700 dark:text-gray-300"
                    placeholder="Por favor ingrese el precio del posto" />
            </div>

            @empty($post->variants->count() > 0)
                <div class="mb-4">
                    <x-label class="mb-1">
                        Stock
                    </x-label>
                    <x-input type="number" wire:model="postEdit.stock" class="w-full dark:bg-gray-700 dark:text-gray-300"
                        placeholder="Por favor ingrese el stock del posto" />
                </div>
            @endempty
            ...
            <div class="mb-4">
                ...
                <x-select name="category_id" class="w-full dark:bg-gray-700 dark:text-gray-300" wire:model.live="postEdit.subcategory_id">
                    <option value="" disabled>
