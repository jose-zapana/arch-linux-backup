    ...
    <form wire:submit.prevent="store">
        ...
        <figure class="mb-4 relative">
            ...
            <img id="picture" class="aspect-[16/9] object-cover object-center w-1/2 mx-auto rounded-lg shadow-md dark:shadow-lg" 
                 src="{{ $file ? $file->temporaryUrl() : (isset($post->image_path) ? Storage::url($post->image_path) : asset('img/no-image.png')) }}" 
        ...
        <div class="card dark:bg-gray-800">
            ...
            <div class="mb-4">
                <x-label class="mb-1">Extracto</x-label>
            ...
            <div class="mb-4">
                <x-label class="mb-1">Cuerpo del Post</x-label>
