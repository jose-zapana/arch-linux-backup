    ...
    <x-container>
        <div class="card bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200">
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <!-- Textarea con clase 'post-body' -->
                <div class="col-span-2 mt-4">
                    <label for="product-details" class="block text-gray-700 dark:text-gray-300 font-medium mb-2">
                        Detalles adicionales del producto:
                    </label>
                    <textarea 
                        id="product-details" 
                        name="product_details" 
                        class="post-body w-full px-4 py-2 text-gray-800 dark:text-gray-200 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-400 dark:focus:ring-indigo-300 focus:border-transparent"
                        rows="5" 
                        placeholder="Escribe aquí detalles adicionales del producto..."></textarea>
                </div>
            </div>
        </div>
    </x-container>
