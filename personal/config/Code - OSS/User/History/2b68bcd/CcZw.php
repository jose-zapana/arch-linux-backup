    ...
    <x-container>
        <div class="card bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <section class="text-sm mt-4 bg-white dark:bg-gray-900 p-4 rounded-lg shadow-md" aria-labelledby="description-title">
                    <h2 id="description-title" class="text-lg font-semibold text-gray-700 dark:text-gray-300">Descripción</h2>
                    <div class="post-body text-base text-gray-700 dark:text-gray-200 mt-4 leading-7 overflow-auto">
                        {!! $product->description !!}
                    </div>
                </section>
