 ...
 */
 ...
 return [
    'meta' => [
         ...
         */
        'defaults'       => [
            'title'        => "PC-Hard Technology", // Título predeterminado
            'titleBefore'  => true, // Coloca el título predeterminado antes del título de la página
            'description'  => 'PC-Hard Technology: Soluciones en tecnología, venta de hardware y ensamblaje de ordenadores. Innovamos para potenciar tu mundo digital.', // Descripción principal
            'separator'    => ' | ',
