<div>
    <div class="grid grid-cols-1 lg:grid-cols-7 gap-6 dark:bg-gray-900 dark:text-white">
                ...
                <ul class="space-y-4">
                    @forelse (Cart::content() as $item)
                        <li class="lg:flex">
                            ...
                            class="w-full sm:w-1/2 md:w-1/3 lg:w-36 aspect-[16/9] object-cover object-center mr-2">
                            <div class="w-80">
                                <p class="text-sm">
        ...
        <div class="lg:col-span-2">
            <div class="card dark:bg-gray-900">
                <div class="flex justify-between font-semibold mb-2">
                    <p class="dark:text-gray-300"> Total </p>
                    <p class="dark:text-gray-300"> {{ Cart::total() }} USD</p>
                </div>
