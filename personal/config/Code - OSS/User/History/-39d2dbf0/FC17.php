...
class CoverController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $imageName = hexdec(uniqid()).'.'.$request->image->getClientOriginalExtension();      
        ...
        $image->toWebp(60)->save(storage_path('app/public/covers/'.$imageName));
    ...
    public function store(Request $request)
    {
        ...
        // Crear administrador de imágenes
        ...
        $image->encode('webp', 60)->save(storage_path('app/public/covers/'.$imageName));
        // Guardar la imagen procesada en el sistema de archivos
        $save_url = 'covers/'.$imageName;            
