...
<article class="mb-8 bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
  ...
  @if ($post->image)
    <img class="w-full h-56 object-cover object-center" src="{{ Storage::url($post->image->url) }}" alt="">
  @else
    <img class="w-full h-56 object-cover object-center" src="https://cdn.pixabay.com/photo/2018/01/14/23/12/nature-3082832_960_720.jpg" alt="">
  @endif  
