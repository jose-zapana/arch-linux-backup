...
<form action="{{ route('admin.posts.categories.update', $category) }}" method="POST">
    @csrf
    ...
    <div class="card dark:bg-gray-800 dark:text-white">
        ...
        <div class="mb-4">
            ...
            <x-input class="w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" placeholder="Ingrese el nombre de la categoría" name="name" id="name" value="{{ old('name', $category->name) }}" />
        </div>
        ...
        <div class="mb-4">
            ...
            <x-input class="w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" placeholder="Ingrese el slug de la categoría" name="slug" id="slug" value="{{ old('name', $category->slug) }}" readonly/>
        </div>
...
<form action="{{ route('admin.posts.categories.destroy', $category) }}" method="POST" id="delete-form">
