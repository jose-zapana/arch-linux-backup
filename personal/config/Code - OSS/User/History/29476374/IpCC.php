...
<head>
    ...
    <link rel="stylesheet" href="{{ url('intranet/assets/css/invoice/style.css') }}" type="text/css" media="all" />
                                        ...
                                        <<tbody>
                                            <tr>
                                                <td class="border-r pr-4">
                                                    <div>
                                                        <p class="whitespace-nowrap text-slate-400 text-right">Fechas</p>
