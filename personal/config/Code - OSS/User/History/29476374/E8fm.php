...
<head>
    ...
    <link rel="stylesheet" href="{{ public_path('intranet/assets/css/invoice/style.css') }}" type="text/css" media="all" />
    ...
    <div>
        <div class="py-4">
                    ...
                    <tbody>
                        <tr>
                            <td class="w-full align-top">
                                <div>
                                    <img src="{{ public_path('img/logo.png') }}" class="w-[70px] h-[70px]" />
                                </div>
                            </td>
            ...
            <div class="px-14 text-sm text-neutral-700">
                ...
                <p>En Soles: 2003006898783 | 00320000300689878330</p>
                <p>En Dolares: 2003006898790 | 00320000300689879035</p>
            </div>
