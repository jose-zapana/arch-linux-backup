<div>    
    ...
    <button wire:click="enableNextButton" class="btn bg-indigo-500 text-white block w-full mt-4 py-2 text-center text-base md:text-lg hover:bg-indigo-600 transition">
        Siguiente
    </button>
