<div>    
    ...
    <button wire:click="$emit('enableNextButton')" class="btn bg-indigo-500 text-white block w-full mt-4 py-2 text-center text-base md:text-lg hover:bg-indigo-600 transition">
        Siguiente
    </button>
    ...
    <div class="col-span-1">
        ...
        @else
            <p class="text-center">Para continuar con la compra, complete los detalles del resumen</p>
        @endif
    </div>
</div>
