    ...
    public function filters(): array
    {
        return [
            SelectFilter::make('Status')
                ->options([
                    '' => 'Todos',
                    ShipmentStatus::Pending->name => ShipmentStatus::Pending->name,
                    ShipmentStatus::Completed->name => ShipmentStatus::Completed->name,
                    ShipmentStatus::Failed->name => ShipmentStatus::Failed->name
                ])
        ];
    }
