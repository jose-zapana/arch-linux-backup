...
<div class="dark:bg-gray-900 dark:text-white">
    <form wire:submit="store">
        <figure class="mb-4 relative">
            ...
            <img fetchpriority="high" class="aspect-[16/9] object-cover object-center w-1/2 mx-auto" 
            src="{{ $product->getFirstMedia('images') ? $product->getFirstMedia('images')->temporaryUrl() : asset('img/no-image.png') }}" 
