...
<div class="dark:bg-gray-900 dark:text-white">
    <form wire:submit="store">
        <figure class="mb-4 relative">
            ...
            src="{{ $product->getFirstMediaUrl('images', 'mobile_small') ?: ($image ? $image->temporaryUrl() : asset('img/no-image.png')) }}" 
            alt="">

            <img class="aspect-[16/9] object-cover object-center w-1/2 mx-auto" src="{{ $image->getFirstMediaUrl('images', 'mobile_small') ? $image->temporaryUrl() : asset('img/no-image.png') }}" alt="">
