    ...
    <form wire:submit="store">
        ...
        <div class="card dark:bg-gray-800">
            ...
            <div class="mb-4" wire:ignore>
                ...
                <x-textarea wire:model="productEdit.description" id="description" name="description" class="w-full dark:bg-gray-700 dark:text-gray-300"
            ...
            <div class="mb-4" wire:ignore>
                ...
                <textarea name="description" id="description" class="w-full dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600 dark:placeholder-gray-400">
                    {!! old('description', $product->description) !!}
                </textarea>
            </div>
