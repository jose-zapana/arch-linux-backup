...
class ProductEdit extends Component
{
    ...
    {
        $this->productEdit = $product->only('barcode', 'name', 'description', 'image_path', 'price', 'stock', 'subcategory_id');
    ...
    public function store()
    {
        $this->validate([
            ...
            'productEdit.barcode' => 'required|unique:products,barcode,' . $this->product->id,
