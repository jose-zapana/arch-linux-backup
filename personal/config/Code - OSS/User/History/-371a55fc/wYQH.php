...
use Illuminate\Support\Arr;  // Asegúrate de importar la clase Arr
...
class ProductEdit extends Component
{
    ...
    public function store()
    {
        ...
        // Eliminar el campo 'stock' de la actualización usando Arr::except()
        $this->productEdit = Arr::except($this->productEdit, ['stock']);
