...
class CheckoutController extends Controller
{
    ...
    private function generateFormToken($total)
    {
        ...
        $response = Http::withHeaders([
            ...
            'amount' => $amount,
            'currency' => config('services.izipay.currency'),
    ...
    public function izipay(Request $request)
    {
        ...
        $data = [
            ...
            'content' => $content,
            'address' => $address,
            'payment_id' => $krAnswerDecoded['orderDetails']['orderId'],
            'total' => number_format(($krAnswerDecoded['orderDetails']['orderTotalAmount'] ?? 0) / 100, 2),
        ];
