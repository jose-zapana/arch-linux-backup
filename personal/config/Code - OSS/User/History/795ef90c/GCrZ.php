<x-app-layout>
    ...
    <div class="-mb-32 text-gray-700 dark:text-gray-300 min-h-[380px]" x-data="{ pago: '1' }">
            ...
            <div class="col-span-1" x-cloak x-show="pago == 1">
                <div class="lg:max-w-[40rem] py-12 px-4 sm:pr-6 lg:pl-8 lg:pr-8 mr-auto">
                    ...
                    <div class="flex justify-between dark:text-gray-300">
                        ...
                        <p>
                            {{ Cart::instance('shopping')->subtotal() }} USD
                        </p>
                    </div>
                    ...
                    <div class="flex justify-between dark:text-gray-300">
                        ...
                        <p>
                            {{ Cart::instance('shopping')->tax() }} USD
                        </p>
                    </div>
                    {{-- <div class="flex justify-between dark:text-gray-300">
                        <p>
                    ...
                    <div class="flex justify-between dark:text-gray-300">
                        ...
                        <p>
                            {{ Cart::instance('shopping')->total() }} USD
                        </p>
