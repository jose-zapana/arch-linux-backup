                            ...
                            <li>
                                ...
                                <div class="border-t border-gray-400 dark:border-gray-700 p-4 bg-gray-100 dark:bg-gray-800 flex justify-center" x-cloak x-show="pago == 2">
                                    ...
                                    <div class="dark:text-gray-300">
                                        ...
                                        <p>- Interbank Soles: 2003006898783</p>
                                        <p>- CCI: 00320000300689878330</p>
                                        <p>- Razón Social: PCHARD S.A.C - PC-HARD TECHNOLOGY</p>
                                        <p>- RUC: 20610015213</p>
                                        <p>- Pago por Yape o Plin</p>
                                        <img style="width: 250px; height: 250px;" class="ml-auto" src="{{ asset('img/qr.jpeg') }}" alt="">
            ...
            <div class="col-span-1" x-cloak x-show="pago == 1">
                <div class="lg:max-w-[40rem] py-12 px-4 sm:pr-6 lg:pl-8 lg:pr-8 mr-auto">
                        ...
                        @foreach (Cart::instance('shopping')->content() as $item)
                            <li class="flex items-center space-x-4 dark:text-gray-300">
                                ...
                                <div class="flex-shrink-0 relative">
                                    ...
                                    <img class="h-16 aspect-square object-cover" 
                                    src="{{ $item->model->getFirstMediaUrl('images', 'product') ?: asset('img/no-image.png') }}" 
                                    alt="{{ $item->name }}">
                                    <div
                    ...
                    <div class="flex justify-between dark:text-gray-300">
                        <p>
                            Precios de envio
                            <i class="fas fa-info-circle" title="El precio de envío es de S/. 30.00"></i>
                        </p>
                        <p>
                            S/ {{ $delivery }}
                        </p>
