    ...
    var onScan = {
        ...
        attachTo: function (oDomElement, oOptions) {
            if (oDomElement.scannerDetectionData !== undefined) {
                throw new Error(
                    "onScan.js is already initialized for DOM element " +
                        oDomElement
                );
            }
        ...
        detachFrom: function (oDomElement) {
            ...
            if (
                oDomElement.scannerDetectionData.options.scanButtonKeyCode !==
                false
            ) {
        ...
        _handleKeyUp: function (e) {
            ...
            if (
                iKeyCode == this.scannerDetectionData.options.scanButtonKeyCode
            ) {
