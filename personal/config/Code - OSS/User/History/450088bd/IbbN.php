...
Route::get('/share/whatsapp', function (Request $request) {
    $phone = $request->input('phone', '51963971686');
    $url = $request->input('url', url('/'));
    return redirect("https://api.whatsapp.com/send?phone={$phone}&text={$url}");
})->name('whatsapp.share');
