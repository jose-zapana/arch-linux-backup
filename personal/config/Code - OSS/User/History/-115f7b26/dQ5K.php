                ...
                <div class="add_input_fields space-y-4">
                    <div class="grid grid-cols-6 gap-4 items-center">
                        ...
                        <input 
                            ...
                            name="cantidad[]" 
                            placeholder="Cant" 
                            class="text-center px-2 py-1 border rounded-md focus:ring-indigo-500 focus:border-indigo-500 text-sm w-30">
                        <input 
                            type="number" 
                            name="precio[]" 
                            placeholder="Precio" 
        ...
        if (x < max_fields) {
            ...
            $(wrapper).append(
                '<div class="grid grid-cols-6 gap-4 items-center mt-4">' +
                    '<input type="text" name="descripcion[]" placeholder="Descripción" class="col-span-2 px-2 py-1 border rounded-md focus:ring-indigo-500 focus:border-indigo-500 text-sm w-full">' +
                    '<input type="number" name="cantidad[]" placeholder="Cant" class="text-center px-2 py-1 border rounded-md focus:ring-indigo-500 focus:border-indigo-500 text-sm w-30">' +
                    '<input type="number" name="precio[]" placeholder="Precio" class="text-center px-2 py-1 border rounded-md focus:ring-indigo-500 focus:border-indigo-500 text-sm w-30">' +
                    '<input type="number" name="total[]" placeholder="Total" class="text-center px-2 py-1 border rounded-md focus:ring-indigo-500 focus:border-indigo-500 text-sm w-30">' +
