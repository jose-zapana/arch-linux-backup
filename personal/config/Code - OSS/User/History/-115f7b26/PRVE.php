    ...
    <div class="grid grid-cols-1 lg:grid-cols-7 gap-6 mt-6">
        <div class="lg:col-span-5">
            <div class="bg-gray-50 dark:bg-gray-900 dark:text-gray-100 p-6 rounded-lg shadow-md">
                <div class="grid grid-cols-5 gap-4 items-center font-semibold text-sm border-b border-gray-300 pb-2 mb-4">
                    <p>Descripción</p>
                    <p>Cantidad</p>
                    <p>Precio</p>                    
                    <p>Total</p>
                ...
                <div class="add_input_fields space-y-4">
                    <div class="grid grid-cols-6 gap-4 items-center">
                        <input 
                            ...
                            class="col-span-2 px-2 py-1 border rounded-md focus:ring-indigo-500 focus:border-indigo-500 text-sm">
                        <input 
                            type="text" 
                            name="cantidad[]" 
                            placeholder="Cantidad" 
                            class="px-2 py-1 border rounded-md focus:ring-indigo-500 focus:border-indigo-500 text-sm w-16">
                        <input 
                            type="text" 
                            name="precio[]" 
                            placeholder="Precio" 
                            class="px-2 py-1 border rounded-md focus:ring-indigo-500 focus:border-indigo-500 text-sm w-20">
                        <input 
                            type="text" 
                            name="total[]" 
                            placeholder="Total" 
                        ...
                        <button 
                            type="button" 
                            class="text-white bg-indigo-500 hover:bg-indigo-600 px-2 py-1 rounded-md add_field_button text-sm">
                            +
                        </button>
                    </div>
                </div>
