                ...
                <div class="add_input_fields space-y-4">
                    <div class="grid grid-cols-6 gap-4 items-center">
                        <input 
                            ...
                            class="col-span-2 px-2 py-1 border rounded-md focus:ring-indigo-500 focus:border-indigo-500 text-sm w-60">
                        <input 
                            type="number" 
                            name="cantidad[]" 
                            placeholder="Cant" 
                            class="text-center px-2 py-1 border rounded-md focus:ring-indigo-500 focus:border-indigo-500 text-sm w-20">
                        <input 
                            type="number" 
                            name="precio[]" 
                            placeholder="Precio" 
