<x-app-layout>
    <x-container class="px-4 mt-12" x-data="{ hasAddresses: false }" x-init="
        Livewire.on('addressesUpdated', value => {
            hasAddresses = value;
        });
    ">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 dark:bg-gray-900 dark:text-white">
            ...
            <div class="col-span-1">
                ...
                <!-- Mostrar el botón solo si hasAddresses es true -->
                <a href="{{ route('checkout.index') }}" 
                   class="btn bg-[#00a1b4] text-white block w-full mt-4 py-2 text-center text-base md:text-lg hover:bg-[#008c95] transition"
                   x-show="hasAddresses">
                    Siguiente
                </a>
            </div>
