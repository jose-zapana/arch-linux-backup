        ...
        <div class="grid grid-cols-2 gap-4 mb-4">
          ...
          <div> 
            ...
            <x-select class="w-full"
              ...
              <option value="1" @selected(old('type', $drive->type) == 1)>
                  Motocicleta
              </option>
  
              <option value="2" @selected(old('type', $drive->type) == 2)>
                  Automovil
              </option>
          ...
          <div>          
            ...
            <x-input class="w-full" placeholder="Ej: AAA-123" name="plate_number" value="{{ old('plate_number') }}" />
          </div>
        </div>
