...
class BlogController extends Controller
{
    ...
    public function store(PostRequest $request)
    {
        ...
        foreach ($images as $image) {
            // Agregar la imagen desde la URL a Media Library
            $mediaItem = $post->addMediaFromUrl(public_path($image))
                              ->toMediaCollection('posts');
    
            // Reemplazar la URL temporal por la nueva URL generada por Media Library
            $replacedUrls[$image] = $mediaItem->getUrl();
