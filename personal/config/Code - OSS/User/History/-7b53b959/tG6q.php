                ...
                <article class="bg-white dark:bg-gray-800 overflow-hidden sm:rounded-lg flex flex-col h-full">
                    <figure class="product-img">
                        <a href="{{ route('products.show', $product) }}" aria-label="Ver detalles del producto: {{ $product->name }}">
                            <img 
                                fetchpriority="high"
                                src="{{ $product->getFirstMediaUrl('images', 'product') }}" 
                                srcset="
                                    {{ $product->getFirstMediaUrl('images', 'mobile') }} 400w, 
                                    {{ $product->getFirstMediaUrl('images', 'tablet') }} 800w, 
                                    {{ $product->getFirstMediaUrl('images', 'product') }} 1200w"
                                sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
