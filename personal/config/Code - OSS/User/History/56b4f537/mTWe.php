<div x-data="{ open: false }">
    <header class="bg-[#212B38] dark:bg-[#1E293B]">
        ...
        <x-container class="px-4 py-4">
            <div class="flex justify-between items-center space-x-8">
                ...
                {{-- Solo renderizar el buscador si NO estamos en la página de inicio (welcome.index) --}}
                @if(!request()->routeIs('welcome.index'))
                    ...
                    {{-- Buscador en dispositivos móviles --}}
                    <div class="md:hidden">
                        <x-input oninput="search(this.value)" type="text" class="w-full bg-gray-200 dark:bg-gray-800 text-gray-700 dark:text-gray-300" placeholder="Buscar..." />
                    </div>
                @endif
    ...
    <div x-show="open" x-on:click="open=false" style="display: none" class="fixed top-0 left-0 inset-0 bg-black opacity-25 z-10"></div>
