            ...
            <div class="flex justify-between items-center space-x-8">
                ...
                <h1 class="text-white">
                    <a href="/" class="inline-flex flex-col items-end">
                        <span class="text-2xl leading-3 md:leading-4 font-semibold">
                ...
                <div class="flex-1 hidden md:block">
                    <x-input oninput="search(this.value)" type="text" class="w-full" placeholder="Buscar..." />
                </div>
                        ...
                        <x-slot name="content">
                            @guest
                                <div class="px-4 py-2">
                                    ...
                                    <p class="text-sm text-center mt ">
                                        ¿No tienes cuenta?
    ...
    <div x-show="open" style="display: none" class="fixed top-0 left-0 z-20">
        ...
        <div class="flex">
            ...
            <div class="w-screen  md:w-80 h-screen bg-white">
                ...
                <div class="px-4 py-3 bg-[#212B38] text-white font-semibold">
                        ...
                        @foreach ($families as $family)
                            <li wire:mouseover="set('family_id', {{ $family->id }})">
                                <a href="{{ route('families.show', $family) }}"
                                    class="flex px-4 py-4 items-center justify-between hover:bg-gray-200">
                                    {{ $family->name }}
            ...
            <div class="w-80 xl:w-[57rem] pt-[52px] hidden md:block">
                ...
                <div class="bg-white h-[calc(100vh-52px)] overflow-auto px-6 py-8">
                    ...
                    <div class="mb-8 flex justify-between items-center">
                        {{-- Cabecera sidabear --}}
                        <p class="border-b-[3px] border-[#00a1b4] font-semibold text-lg uppercase pb-1">
                            {{ $this->familyName }}
                        </p>
                                    ...
                                    @foreach ($category->subcategories as $subcategory)
                                        <li>
                                            <a href="{{ route('subcategories.show', $subcategory) }}"
                                                class="text-gray-600 text-sm hover:text-[#00a1b4]">
                                                {{ $subcategory->name }}
                                            </a>
                                        </li>
                                    @endforeach
