<div x-data="{ open: false }">
            ...
            <div class="flex justify-between items-center space-x-8">
                ...
                <h1 class="text-white dark:text-gray-300">
                    <a href="/" class="inline-flex flex-col items-end">
                        <img src="{{ asset('img/logo-pchard.webp') }}" 
                        class="h-16 me-3" 
                        alt="pchard Logo" 
                        width="64" 
                        height="64" />
                ...
                <div class="flex items-center space-x-4 md:space-x-8">
                    <x-dropdown>
                        <x-slot name="trigger">
                            @auth
                                <button class="flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition" aria-label="Abrir menú de usuario">
                        ...
                        <x-slot name="content">
                            ...
                            @else
                                ...
                                <x-dropdown-link :href="route('admin.dashboard')" class="text-gray-700 dark:text-gray-300">
                                    Dashboard
                                </x-dropdown-link>
                                @endcan
    ...
    <div x-show="open" x-on:click="open=false" style="display: none"
        class="fixed top-0 left-0 inset-0 bg-black opacity-25 z-10" aria-label="Cerrar superposición de fondo">
    </div>
