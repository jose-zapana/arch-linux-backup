<div class="card dark:bg-gray-800 dark:text-white">
    <form wire:submit.prevent="save" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <x-input id="name" wire:model.defer="post.title" class="w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" placeholder="Escribe un título" autocomplete="off" />
        </div>
        <div class="mb-4">
            <x-label for="slug" class="mb-2 dark:text-gray-300">Slug</x-label>
            <x-input id="slug" wire:model.defer="post.slug" class="w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" placeholder="Ingrese el slug de la categoría" />
        </div>
        ...
        <div class="mb-4 text-gray-700">
            ...
            <textarea wire:model.defer="post.extract" id="extract" class="w-full dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600 dark:placeholder-gray-400"></textarea>
        </div>
        
        <div class="mb-4 text-gray-700">
            <x-label class="mb-2 dark:text-gray-300">Cuerpo del post</x-label>
            <textarea wire:model.defer="post.body" id="body" class="w-full dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600 dark:placeholder-gray-400"></textarea>
        </div>
