<div class="card dark:bg-gray-800 dark:text-white">
    <form wire:submit.prevent="save" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            <x-input type="hidden" wire:model.defer="post.user_id" value="{{ Auth::user()->id }}" />
        ...
        <div class="mb-4">
            ...
            <div class="flex items-center space-x-2">
                <div class="flex items-center space-x-2">
                    <input type="radio" wire:model.defer="post.status" id="status1" value="1" aria-labelledby="status1">
                    <label for="status1">Borrador</label>
                </div>
                <div class="flex items-center space-x-2">
                    <input type="radio" wire:model.defer="post.status" id="status2" value="2" aria-labelledby="status2">
        ...
        <div class="mb-4 text-gray-700">
            ...
            <x-textarea wire:model.defer="post.extract" id="extract" class="w-full dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600 dark:placeholder-gray-400">{{ old('extract') }}</x-textarea>
        </div>
  
        <div class="mb-4 text-gray-700">
            <x-label class="mb-2 dark:text-gray-300">Cuerpo del post</x-label>
            <x-textarea wire:model.defer="post.body" id="body" class="w-full dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600 dark:placeholder-gray-400">{{ old('body') }}</x-textarea>
        </div>
