...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        Livewire.on('initializeCKEditor', () => {
            // Si ya hay una instancia, destrúyela
            if (editorInstance) {
            ...
            ClassicEditor
                ...
                .then(editor => {
                    ...
                    // Cargar el contenido del editor desde Livewire
                    editor.setData(@js($post['body']));

                    // Escuchar cambios en el editor y enviar a Livewire
