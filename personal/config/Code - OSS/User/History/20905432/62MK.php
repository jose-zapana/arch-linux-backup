<div class="card dark:bg-gray-800 dark:text-white">
    <form wire:submit.prevent="save" enctype="multipart/form-data">
        ...
        <div class="mb-4 text-gray-700" livewire:ignore>
...
<script>
    document.addEventListener('livewire:load', function () {
        ...
        function createEditor() {
            ClassicEditor
                ...
                .then(editor => {
                    ...
                    // Set the initial data from Livewire
                    editor.setData(@this.get('post.body'));

                    // Listen to changes in CKEditor and update Livewire
        ...
        // Re-initialize CKEditor after each Livewire render
