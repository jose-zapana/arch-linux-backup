...
<script>
    document.addEventListener('livewire:load', function () {
        ClassicEditor
            ...
            .then(editor => {
                // Asignar el editor a una variable global para posibles usos futuros
                window.editor = editor;

                // Escuchar cambios en CKEditor y actualizar Livewire
    ...
    Livewire.hook('message.processed', (message, component) => {
        if (window.editor) {
            window.editor.setData(@this.get('post.tags'));
        }
    });
</script>
