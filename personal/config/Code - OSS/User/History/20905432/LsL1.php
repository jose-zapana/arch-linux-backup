<div class="card dark:bg-gray-800 dark:text-white">
    <form wire:submit.prevent="save" enctype="multipart/form-data">
        ...
        <div class="mb-4 text-gray-700">
            ...
            <x-textarea wire:model.defer="post.body" id="body" class="w-full dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600 dark:placeholder-gray-400" livewire:ignore></x-textarea>
        </div>
