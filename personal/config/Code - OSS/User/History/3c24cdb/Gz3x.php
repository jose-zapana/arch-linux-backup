...
class WelcomeController extends Controller
{
    public function index()
    {
        ...
        SEOTools::opengraph()->setUrl(''); // URL correcta
        SEOTools::setCanonical(''); // URL canónica
        SEOTools::opengraph()->addProperty('type', 'website'); // Tipo de contenido
        SEOTools::twitter()->setSite('@PCHARD_SAC'); // Twitter Handle
        SEOTools::jsonLd()->addImage(''); // Imagen de JSON-LD      
        ...
        SEOMeta::setDescription('PC-HARD S.A.C. ofrece soluciones completas en tecnología: venta de computadoras, laptops, impresoras y accesorios. Especialistas en soporte técnico y mantenimiento en La Molina, Cieneguilla y Manchay.');
        ...
        JsonLd::setDescription('PC-HARD S.A.C. ofrece soluciones completas en tecnología: venta de computadoras, laptops, impresoras y accesorios. Especialistas en soporte técnico y mantenimiento en La Molina, Cieneguilla y Manchay.');
        JsonLd::addImage('https://pc-hard.com/img/default_image.png');
