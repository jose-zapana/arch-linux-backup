<div>
    ...
    <div x-data="{ 
        ...
        type="button">
        <svg class="w-6 h-6 mr-2 fill-current text-white dark:text-gray-900" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
        ...
        <span class="text-center w-full dark:text-gray-900">Solicítalo</span>
        </button>
