<div>
    ...
    <div x-data="{ 
        ...
        <button 
        class="flex justify-center items-center gap-2 px-4 py-2 bg-green-600 text-white font-semibold text-sm rounded-lg shadow-lg transition-all hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-gray-100 dark:bg-green-500 dark:hover:bg-green-600 dark:focus:ring-green-400 w-full mb-6" 
        ...
        type="button">
        <svg class="w-6 h-6 fill-current text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true">
        ...
        <span class="text-center text-white">Solicítalo</span>
    </button> 
