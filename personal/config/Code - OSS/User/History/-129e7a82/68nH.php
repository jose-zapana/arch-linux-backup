...
<button 
    class="btn bg-blue-500 text-white hover:bg-blue-600 dark:bg-blue-700 dark:text-white dark:hover:bg-gray-600 dark:disabled:bg-gray-700 disabled:text-gray-400 disabled:bg-gray-300 w-full mb-6" 
    wire:click="add_to_cart" 
    :disabled="stock === 0">
    Agregar al carrito
</button>
