<div>
    ...
    <button 
        class="btn bg-blue-500 text-white hover:bg-blue-600 dark:bg-blue-700 dark:text-white dark:hover:bg-gray-600 disabled:text-gray-400 disabled:bg-gray-600 w-full mb-6" 
