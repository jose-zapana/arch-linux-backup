<div>
    ...
    <div x-data="{ 
        ...
        type="button">
        <svg class="w-6 h-6 fill-current text-gray-800 dark:text-gray-900" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
        ...
        <span class="text-center dark:text-gray-900">Solicítalo</span>
        </button> 
