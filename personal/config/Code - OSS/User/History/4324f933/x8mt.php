        ...
        @if (session('niubiz'))
            ...
            <div class="flex items-center p-4 mb-4 text-sm text-blue-800 border border-blue-300 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 dark:border-blue-800"
                ...
                <div>
                    ...
                    <p><strong>Estado del Pago:</strong> {{ $izipay['response']['status'] }}</p>
                    <p><strong>Número de Pedido:</strong> {{ $izipay['purchasenumber'] }}</p>
                    <p><strong>Monto:</strong> {{ number_format($izipay['response']['amount'] / 100, 2) }} {{ $izipay['response']['currency'] }}</p>
                </div>
            </div>
