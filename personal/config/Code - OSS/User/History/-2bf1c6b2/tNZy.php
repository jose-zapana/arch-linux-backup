...
class PostCreate extends Component
{
    ...
    public function __construct($id = null)
    {
        ...
        $this->categoryTagService = app(CategoryTagService::class);
    }
    ...
    public function mount($post = null)
    {
        ...
        // Cargar categorías y etiquetas en mount() solo una vez usando el servicio
        $this->categories = $this->categoryTagService->getAllCategories();
        $this->tags = $this->categoryTagService->getAllTags();
    }
